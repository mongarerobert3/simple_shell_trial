 ...
 * @name: the value of teh name field of the new node
 * @value: teh value itself of the new node
 * 
 * Return: head of teh new lsit otherwise null
 * 
 */
...
list_t *add_node_end(list_t **head, const char *name, const char *value)
{
        ...
        /* traverse to the end of the end of the list */
...
/**
 * print_list  - prints all the elements of a list_t list in agiven format
 * @h: pointer to a list_t
 * 
 * Return: number of nodes in a given list_t
 */
 ...
 * @value: value of teh value field
 * 
...
/**
 * list to array - converts a given listof string into an array of strings
 * @h: head of a given list
 * 
...
int delete_node_name(list_t **head, const char *name)
{
        ...
        /* go to the node just before the node we want to delete */
...
int delete_node_index(list_t **head, int index)
{
        ...
        /* if you are deleting from the first node */
        ...
        /* go to the node just before the node we are deleting */
...
/**
 * find_name - finds the index of a node with the given name ina list_t
 * @h: head of list_t
 * @name: name of node
 * 
...
/**
 * split_string - splits a given string using a certain delimiter
 * @str: string to split
 * @delim: delimiter
 * 
